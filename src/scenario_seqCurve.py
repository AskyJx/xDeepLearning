...
class Params:
    ...
    VALIDATION_CAPACITY = TESTING_EXAMPLES  # 验证集大小
...
def main_rnn():
    ...
    # rnn
    # rnn1 = RnnLayer('rnn1',Params.MINI_BATCH_SIZE,Params.HIDDEN_SIZE,3,optimizer,optmParamsRnn1,Params.DTYPE_DEFAULT,Params.INIT_RNG)

    #LSTM
    rnn1 = LSTMLayer('lstm1',Params.MINI_BATCH_SIZE,Params.HIDDEN_SIZE,3,optimizer,optmParamsRnn1,Params.DTYPE_DEFAULT,Params.INIT_RNG)

    #GRU
    # rnn1 = GRULayer('gru1',Params.MINI_BATCH_SIZE,Params.HIDDEN_SIZE,3,optimizer,optmParamsRnn1,Params.DTYPE_DEFAULT,Params.INIT_RNG)

    optmParamsFc1=(Params.BETA1, Params.BETA2, Params.EPS)
    fc1 = FCLayer(Params.MINI_BATCH_SIZE, Params.HIDDEN_SIZE, 1, NoAct,
                  AdamOptimizer, optmParamsFc1,Params.DTYPE_DEFAULT,Params.INIT_W)
    ...
    for epoch in range(Params.EPOCH_NUM):
        ...
        for batch in range(len(dataRngs)):
            ...
            if (batch % Params.VAL_FREQ == 0 and (batch + epoch) > 0):
                ...
                y, loss_v,_ = sess.validation(x_v, y_v)
